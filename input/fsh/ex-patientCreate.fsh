...
Instance: ex-auditBasicCreate
InstanceOf: PatientCreate
Title: "Audit Example of a basic patient identifiable Create"
...
InstanceOf: PatientCreate
Title: "Audit Example of a basic patient identifiable Create with no user"
...
InstanceOf: PatientCreate
Title: "Audit Example of a basic patient identifiable Create of a Report with no user"
...
InstanceOf: PatientCreate
Title: "Audit Example of a basic patient identifiable Create of a Job with no user"
